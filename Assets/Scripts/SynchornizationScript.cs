...
public class SynchornizationScript : MonoBehaviour, IPunObservable
{
    ...
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
    {
        ...
        if (stream.IsWriting)
        {
            // PhotonView is owned by user and now controls the player
            // Send position, velocity, data to other players
        ...
        {
            // Player gameobject existing in remote player's game
